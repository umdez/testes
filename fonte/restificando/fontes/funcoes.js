...
/* A nossa configuração para a fonte Funcoes.
...
Funcoes.prototype.iniciar = function(opcoes) {
  this.config = this.carregarConfig(opcoes);
};   

Funcoes.prototype.carregarConfig = function(opcoes) {

  var config = {
     nome: 'Funcoes'                  // É o nome dado a tabela (modelo) no banco de dados.
  ...
  config.estagiosFinais = [ 
    '/Funcoes'              
  , '/Funcoes/:id'  // Um registro em especifico.
  ];  
