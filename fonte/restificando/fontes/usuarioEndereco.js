...
/* A nossa configuração para a fonte UsuarioEndereco.
...
UsuarioEndereco.prototype.iniciar = function(opcoes) {
  this.config = this.carregarConfig(opcoes);
};   

UsuarioEndereco.prototype.carregarConfig = function(opcoes) {

  var config = {
     nome: 'UsuarioEndereco'          // É o nome dado a tabela (modelo) no banco de dados.
  ...
  config.estagiosFinais = [ 
    '/UsuarioEndereco'              
  , '/UsuarioEndereco/:id'  // Um registro em especifico.
  ];  
